(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('html2json')) :
	typeof define === 'function' && define.amd ? define(['html2json'], factory) :
	(global = global || self, (function () {
		var current = global.cnfBarcode;
		var exports = global.cnfBarcode = factory(global.html2json);
		exports.noConflict = function () { global.cnfBarcode = current; return exports; };
	}()));
}(this, function (html2json) { 'use strict';

	html2json = html2json && html2json.hasOwnProperty('default') ? html2json['default'] : html2json;
